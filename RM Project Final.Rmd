...
Using the coefficients from the results above, the final model is formalized in the equation below, which explains `r round(100 * sumF2$r.squared, 2)`% of the variation in **mpg**.  An error term is included to account for the residuals.

**mpg** = `r round(sumF2$coef[1,1], 2)` - `r round(-sumF2$coef[2,1], 2)` * **wt** + `r round(sumF2$coef[3,1], 2)` * **am** - `r round(-sumF2$coef[5,1], 2)` * **wt** * **am** + `r round(sumF2$coef[4,1], 2)` * **qsec** + $\epsilon$
